...
document.addEventListener('DOMContentLoaded', () => {
  ...
  { question: "How can we get connected?, How can I approach him?, How can I get help?", answer: "You can send us an Email!" },
  ...
  { question: "Tell me about your boss's personality., How is he as a person?, What is your boss like?, Describe his personality.", answer: "Dr. Jagadish Das is known for his dedication, hard work, and passion for AI and healthcare. He’s down-to-earth, humble, and always ready to help others." },
  { question: "What are his strengths?, What is his greatest strength?, What does he excel at?, What are his best qualities?", answer: "His greatest strengths are his discipline, dedication to his work, and his ability to mentor and guide others with patience and humility." },
  { question: "What are his weaknesses?, What is his biggest weakness?, Does he have any weak points?, Where could he improve?", answer: "While he’s incredibly passionate, sometimes he gets so involved in his projects that he can forget to take breaks. But his drive to keep improving always wins." },
  ...
  { question: "What are his skills?, What does he specialize in?, What are his professional skills?, What are his best abilities?", answer: "He’s highly skilled in AI, deep learning, medical imaging, and programming with Python. His expertise in healthcare research is exceptional." },
  ...
  { question: "What’s his leadership style?, How does he lead?, What’s his approach as a leader?, How is he as a leader?", answer: "He leads by example, with a focus on mentoring and nurturing talent. His leadership is a blend of patience, vision, and guiding others to achieve their best." },
  { question: "Does he have any disciples?, Does he mentor people?, Who are his students?, Has he left a legacy?", answer: "Jagadish has mentored over 100 students in event management and AI. His legacy is in the many students he’s guided, who look up to him as a role model." },
  ...
  { question: "What kind of projects is your boss working on?, What is he currently developing?, What types of projects does he work on?", answer: "Jagadish is currently focused on developing AI systems for healthcare, particularly in disease detection and medical diagnostics." },
  ...
  { question: "What healthcare projects does he do?, Is he focused on healthcare?, What healthcare solutions is he building?", answer: "He is dedicated to building healthcare AI solutions, such as breast cancer prediction models and brain tumor detection systems." },
  { question: "Is he working on any research projects?, What research is he doing?, Is he involved in AI research?", answer: "Yes, Jagadish is actively involved in AI healthcare research, particularly on how AI can assist in early disease diagnosis and risk assessment." },
  ...
  { question: "Does he work on web development?, Is he involved in building websites?, What kind of web projects does he do?", answer: "Yes, Jagadish has worked on several web development projects, including a platform called 'Matrusakti' aimed at supporting safe motherhood through AI-powered chatbots." },
  { question: "What role does AI play in his projects?, How does he use AI?, What AI techniques does he focus on?", answer: "AI is central to his projects, particularly in using machine learning, neural networks, and natural language processing to create predictive healthcare models." },
  { question: "Does he work with big data?, Does he handle large datasets?, Is he involved in data science projects?", answer: "Yes, he works extensively with large medical datasets, including MRI scans and patient data, to build accurate and reliable AI models." }
];
